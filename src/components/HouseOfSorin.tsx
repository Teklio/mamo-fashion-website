      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <Image
            ...
            alt="The House of SORIN Beach Sandals"
            fill
        ...
        <div className="flex flex-col items-center justify-center text-center px-2 lg:px-8">
          ...
          >
            <Link
              href="/shop"
              className="group relative inline-flex items-center justify-center px-10 py-4 border border-zinc-800 rounded-md text-[10px] md:text-xs tracking-[0.25em] text-zinc-900 font-sans font-semibold bg-white hover:bg-zinc-950 hover:text-white transition-all duration-400"
            >
              VIEW COLLECTIONS
            </Link>
          </motion.div>
