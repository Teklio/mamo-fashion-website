...
export default function AccountDetailsPage() {
  ...
  return (
    <div className="bg-white border border-black/10 rounded-2xl p-8 lg:p-10 w-full min-h-150">
      <div className="mb-10">
        <h1 className="font-serif text-2xl lg:text-3xl text-black mb-2">Account Details</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-xl">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="mt-6 w-fit bg-black hover:bg-black/90 text-white text-xs font-sans px-8 py-3.5 rounded-md transition-colors disabled:opacity-70 flex justify-center items-center h-12"
        >
          {isLoading ? (
