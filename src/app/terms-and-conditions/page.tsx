        ...
        <div className="max-w-400 mx-auto">
          ...
          <div className="space-y-12 font-sans text-sm text-zinc-600 leading-relaxed">
            <section>
              ...
              <p className="mb-4">
                Welcome to Mamo.ae. By accessing and using this website, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our website.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Mamo Shoe Trading is an online retailer specializing in footwear products, including shoes, sandals, and slippers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                All website content including text, graphics, logos, images, product descriptions, designs, and software are the property of Mamo Shoe Trading and are protected under applicable intellectual property laws.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                To the maximum extent permitted by law, Mamo Shoe Trading shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of this website or products purchased through it.
              </p>
            </section>
