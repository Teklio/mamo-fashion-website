...
export const metadata: Metadata = {
  title: "SORIN | Refund & Cancellation Policy",
  description: "Read the refund, return, and cancellation policies of HOUSE OF SORIN.",
};
